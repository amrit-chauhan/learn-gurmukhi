...
- Six sections: **Common Words** (~254 everyday essentials), **More Common Words** (~446 broader set), **Words from Songs** (~374 staples of Punjabi music — Sidhu Moose Wala / Karan Aujla / Diljit / Arjan Dhillon, wedding & classic songs), **More Words from Songs** (~511 harder literary / Perso-Arabic / folk song vocabulary), **Days of the Week** (7), **Numbers 0–100** (spoken Punjabi number words).
...
- **Saved selections** (`useSavedSelections`): a selection can be named and saved (per profile, in `localStorage`); saved sets appear on the Practice Words hub and can be re-practiced or deleted.
...
## Stats Calendar
- The Stats page has a **Calendar** tab: a month grid (with prev/next navigation) rendered as a **heatmap** of study (practice) time — green for days with more than 10 minutes, yellow for any study at all, grey otherwise. Tapping any day shows that day's **App time** and **Practice time**.
